        ...
        <nav className="flex justify-between p-4 items-center">
            ...
            <div className="ml-auto">
                {theme==="dark"?
                    ...
                    </svg></button>:<button onClick={toggleTheme} className="rounded-md px-4 py-2 xs:p-0"><svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
